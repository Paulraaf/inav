...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM5, CH3, PA2, TIM_USE_MC_MOTOR, 0, 4),   // S5
    DEF_TIM(TIM5, CH4, PA3, TIM_USE_MC_MOTOR, 0, 5),   // S6
    ...
    DEF_TIM(TIM4, CH3, PD14, TIM_USE_MC_MOTOR , 0, 0),   // S9
    DEF_TIM(TIM4, CH4, PD15, TIM_USE_MC_MOTOR , 0, 0),   // S10 DMA_NONE
